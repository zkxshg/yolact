...
#     ]
# }
#B3 对应的输出是48, 136, 384，所以 OUT_CHANNELS: (48, 136, 384, 256, 256, 256)
#先送入1*1改变通道 bottolenet layer现代架构3*3感受野同样大，节省参数，减少过拟合
# 两层 3*3 模拟1层5*5节省28％　
...
class EfficientNet(nn.Module):
    ...
    def __init__(self, model_name, blocks_args=None, global_params=None):
        ...
        #self.channels = [40, 112, 320, 256, 256, 256]
        self.channels = []
        ...
        for block_args in self._blocks_args:
            ...
            self.channels.append(block_args.output_filters)
            #print(block_args.output_filters)

        self.backbone_modules = self._blocks

from efficientnet.efficinetnet import EfficientNet
from backbone import ResNetBackbone, VGGBackbone, ResNetBackboneGN, DarkNetBackbone,MobileNetV1,MobileNetV2
...
dataset_base = Config({
    ...
    'train_info':   './data/coco2017/annotations/instances_train2017.json',
    # Validation images and annotations.
    'valid_images': './data/coco2017/val2017/',
...
coco2017_testdev_dataset = dataset_base.copy({
    ...
    'valid_info': './data/coco2017/annotations/image_info_test-dev2017.json',
    'has_gt': False,
...
my_custom_dataset = dataset_base.copy({
    ...
    'train_images': './data/car_damage_dataset_7800/car_damage_train/',
    'train_info': './data/car_damage_dataset_7800/annotations/instances_train.json',
    # Validation images and annotations.
    'valid_images': './data/car_damage_dataset_7800/car_damage_val/',
    'valid_info': './data/car_damage_dataset_7800/annotations/instances_val.json',

    'has_gt': True,
    'class_names': MY_CLASSES,
    #'class_names': ('damage',) #fastnms
    #'fastnms':True,
})
...
mobilenet_v1_backbone = resnet50_backbone.copy({
    'name': 'MobileNet_v1',
    'path': 'mobilenet-v1-ssd-mp-0_675.pth',
    'type': MobileNetV1,
})

mobilenet_v2_backbone = resnet50_backbone.copy({
    'name': 'MobileNetV2',
...
peleenet_backbone = backbone_base.copy({
    'name': 'PeleeNet',
    'path': 'peleenet_acc7208.pth.tar',
    'type': PeleeNet,
})
...
activation_func = Config({
    ...
    'leakrelu': lambda x: torch.nn.functional.leaky_relu(x,negative_slope=0.01,inplace=False),
...
yolact_resnet101_mydataset_config = yolact_base_config.copy({
    'name': None,
...
# ============================= darknet53 for DIY ==================================
yolact_darknet53_Mydataset_config = yolact_base_config.copy({
    'name': 'yolact_darknet53_Mydataset',
    'lr': 1e-4,
    'dataset': my_custom_dataset,
    'num_classes': len(my_custom_dataset.class_names) + 1,
    ...
    'mask_proto_prototype_activation':activation_func.leakrelu,
    'mask_proto_mask_activation':activation_func.swish,
    'mask_proto_coeff_activation':activation_func.hardtanh,
    'use_maskiou': True,
    'use_objectness_score': False,
    'maskiou_net': [(8, 3, {'stride': 2}), (16, 3, {'stride': 2}), (32, 3, {'stride': 2}), (64, 3, {'stride': 2}),
                    (128, 3, {'stride': 2}), (256, 3, {'stride': 2})],
...
# ============================= vgg16 for DIY ==================================
yolact_vgg16_mydataset_config = yolact_base_config.copy({
    'name': 'yolact_vgg16_Mydataset',
    'lr': 1e-5,
    'dataset': my_custom_dataset,
    'num_classes': len(my_custom_dataset.class_names) + 1,
...
# ============================= peleenet for DIY ==================================
yolact_peleenet_mydataset_config = yolact_base_config.copy({
    'name': 'yolact_peleenet_Mydataset',
    'lr': 1e-4,
    'dataset': my_custom_dataset,
    'num_classes': len(my_custom_dataset.class_names) + 1,
    ...
    'backbone': peleenet_backbone.copy({
        'selected_layers': list(range(2, 5)),
...
# ============================= mobilenetv1 for DIY ==================================
yolact_mobilenetv1_mydataset_config = yolact_base_config.copy({
    'name': 'yolact_mobilenet_v1',

    'backbone': mobilenet_v1_backbone.copy({
        'pred_scales': yolact_base_config.backbone.pred_scales,
        'pred_aspect_ratios': yolact_base_config.backbone.pred_aspect_ratios,
        'selected_layers': list(range(2, 5)),
...
yolact_mobilenetv2_mydataset_config = yolact_resnet50_config.copy({
    ...
    'backbone': mobilenet_v2_backbone.copy(),
    'use_maskiou': True,
    'use_objectness_score': False,
    'maskiou_net': [(8, 3, {'stride': 2}), (16, 3, {'stride': 2}), (32, 3, {'stride': 2}), (64, 3, {'stride': 2}),
                    (128, 3, {'stride': 2}), (256, 3, {'stride': 2})],
...
yolact_EfficientNet_mydataset_config = yolact_base_config.copy({
    ...
    'backbone': EfficientNet_backbone.copy({
        ...
        'selected_layers': [1, 2, 3],
        'pred_aspect_ratios': [ [[1, 1/2, 2]] ]*5,
        #'pred_scales': [16,24,40,80,112,192,320],
        'pred_scales': [[i * 2 ** (j / 3.0) for j in range(3)] for i in [24, 48, 96, 192, 384]],
...
# ============================= EfficientNet for pascal ==================================
yolact_EfficientNetall_pascal_config = yolact_base_config.copy({
    'name': 'yolact_EfficientNet_all',
    'dataset': pascal_sbd_dataset,
    'num_classes': len(pascal_sbd_dataset.class_names) + 1,
    'fpn': None,
    'max_iter': 120000,
...
yolact_EfficientNetproto_pascal_config = yolact_base_config.copy({
    'name': 'yolact_EfficientNet_proto',
    'dataset': pascal_sbd_dataset,
    'num_classes': len(pascal_sbd_dataset.class_names) + 1,
    'fpn': None,
    'max_iter': 120000,
...
yolact_EfficientNetmask_pascal_config = yolact_base_config.copy({
    'name': 'yolact_EfficientNet_mask',
    'dataset': pascal_sbd_dataset,
    'num_classes': len(pascal_sbd_dataset.class_names) + 1,
    'fpn': None,
    'max_iter': 120000,
...
yolact_EfficientNetcoe_pascal_config = yolact_base_config.copy({
    'name': 'yolact_EfficientNet_coe',
    'dataset': pascal_sbd_dataset,
    'num_classes': len(pascal_sbd_dataset.class_names) + 1,
    'fpn': None,
    'max_iter': 120000,
...
yolact_plus_mydatabase_base_config = yolact_base_config.copy({
    'name': 'yolact_plus_mydatabase_base',
    'dataset': my_custom_dataset,
    'num_classes': len(my_custom_dataset.class_names) + 1,
    'max_iter': 120000,
    'lr_steps': (60000, 100000),
    ...
    'use_maskiou': True,
    'maskiou_net': [(8, 3, {'stride': 2}), (16, 3, {'stride': 2}), (32, 3, {'stride': 2}), (64, 3, {'stride': 2}),(128, 3, {'stride': 2}),(256, 3, {'stride': 2})],
    #'maskiou_net': [(8, 3, {'stride': 2}), (16, 3, {'stride': 2}), (32, 3, {'stride': 2}), (64, 3, {'stride': 2}),(128, 3, {'stride': 2})],
    'mask_proto_net': [(256, 3, {'padding': 1})] * 3 + [(None, -2, {}), (256, 3, {'padding': 1})] + [(32, 1, {})],
    'maskiou_alpha': 1,
    'rescore_bbox': False,
...
yolact_plus_mydatabase_resnet50_config = yolact_plus_base_config.copy({
    'name': 'yolact_plus_mydatabase_resnet50',
    'dataset': my_custom_dataset,
    'num_classes': len(my_custom_dataset.class_names) + 1,
    'max_iter': 120000,
    'lr_steps': (60000, 100000),
